...
<script src="<?= ($BASE) ?>/ui/dist/js/pages/reports.js?v2=s21sss2" type="text/javascript"></script>
<script src="<?= ($BASE) ?>/ui/plugins/datatables/jquery.dataTables.js?v2=12sss" type="text/javascript"></script>
